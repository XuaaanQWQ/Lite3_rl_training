...
class Lite3RoughCfg(LeggedRobotCfg):
    class init_state(LeggedRobotCfg.init_state):
        ...
        default_joint_angles = { # = target angles [rad] when action = 0.0
            ...
            'HL_HipY_joint': -1.1,   # [rad] 
            'FR_HipY_joint': -0.8,     # [rad]
            'HR_HipY_joint': -1.1,   # [rad]
    ...
    class env(LeggedRobotCfg.env):
        ...
        num_privileged_obs = 241  # 54+187=241 if not None a priviledge_obs_buf will be returned by step() (critic obs for assymetric training). None is returned otherwise
